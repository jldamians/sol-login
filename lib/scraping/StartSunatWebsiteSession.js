...
export class StartSunatWebsiteSession {
  ...
  async _selectIdentifierType(code) {
    ...
    try {
      await DispatchClickForElementSupport(this.page, identifierTypeSelector, {
        visible: this.options.visible,
        timeout: this.options.timeout,
      });
    } catch (error) {
      HTMLElementNotFoundError.throwBecauseOf(`Opción de logeo por ${identifierTypeLabel} (${identifierTypeSelector})`);
    }
  }
  /**
